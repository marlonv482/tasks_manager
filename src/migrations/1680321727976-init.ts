...
export class init1680321727976 implements MigrationInterface {
    name = 'init1680321727976'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_projets_access_level_enum" AS ENUM('30', '40', '50')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."users_projets_access_level_enum"`);
