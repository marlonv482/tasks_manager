...
export class init1680119406774 implements MigrationInterface {
    name = 'init1680119406774'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_projets_access_level_enum" AS ENUM('40', '50')`);
